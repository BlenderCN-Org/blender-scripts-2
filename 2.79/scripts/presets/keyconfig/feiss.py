...
kmi = km.keymap_items.new('wm.call_menu', 'SPACE', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'name', 'scriptshortcut.popup')
...
kmi = km.keymap_items.new('export_scene.obj', 'F7', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('wm.collada_export', 'F8', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('export_scene.gltf', 'F9', 'PRESS')
kmi_props_setattr(kmi.properties, 'export_apply', True)
kmi_props_setattr(kmi.properties, 'export_selected', True)
kmi_props_setattr(kmi.properties, 'export_tangents', False)
kmi_props_setattr(kmi.properties, 'export_cameras', False)
kmi_props_setattr(kmi.properties, 'export_embed_buffers', True)
...
kmi = km.keymap_items.new('screen.repeat_history', 'F4', 'PRESS')
...
kmi = km.keymap_items.new('screen.screen_set', 'WHEELDOWNMOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'delta', 1)
kmi = km.keymap_items.new('screen.screen_set', 'WHEELUPMOUSE', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'delta', -1)
...
kmi_props_setattr(kmi.properties, 'uvs', False)
kmi = km.keymap_items.new('mesh.merge', 'Q', 'PRESS', ctrl=True, alt=True)
...
kmi = km.keymap_items.new('rt.rename', 'R', 'PRESS', ctrl=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'name', 'view3d.feiss_tools_menu')
kmi.active = False
